...
### 🐻 만든 이유
3.3.3의 법칙이 있다. 3일을 반복하면 3주를 할 수 있고, 3주를 할 수 있으면 3개월을 할 수 있고 평생 습관이 된다는 말이다. 내가 직접 사용하면서 습관을 내재화할 수 있는 서비스를 만들고 싶었다. 어릴 적 학교에서 사용했던 스티커판을 차용하여 서비스로 구현해보았다. 꾸준한 습관을 들여 자기 발전에 힘쓰자!!!
